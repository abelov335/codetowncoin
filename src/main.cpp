...
uint256 hashGenesisBlock("0x4356cd032318f3976c9cceaca7861b5c173cb0ddbcdba2e892a51686775aa0a2");
...
const string strMessageMagic = "CodeTownCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // CodeTownCoin: 1 days
static const int64 nTargetSpacing = 120; // CodeTownCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal codetowncoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CodeTownCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0ba24a3c64f3fef4f5d642144f5ccb37ad35a7fb05e5cc1fd2a7bea32a2eb457");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Codetowncoin: 04.04.2018 - oo";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1522949487; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 858857;

        if (fTestNet)
        {
            block.nTime    = 1522854530;
            block.nNonce   = 698130;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x37598fe51274778511137ee0b3997ac90b6e4df3d91f44fdbcfc726bde986acc"));
